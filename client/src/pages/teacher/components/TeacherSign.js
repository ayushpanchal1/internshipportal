...
import { uploadSignaturePicture } from "../../../services/TeacherServices";
...
function UploadSignImage(){
  ...
  const handleUpload = () => {
    if (selectedImage) {
      ...
      uploadSignaturePicture(formData);
      handleClose()
    } else {
    ...
    <Container>
      ...
      <Modal show={show} onHide={handleClose}>
        <Modal.Header closeButton>
          <Modal.Title style={{ color: "#802121" }}>Upload Signature Image</Modal.Title>
        </Modal.Header>
        <Modal.Body>
